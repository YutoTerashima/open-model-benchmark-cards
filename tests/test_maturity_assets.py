...
def test_project_specific_maturity_modules_import():
    import open_model_benchmark_cards.card_schema as _card_schema
    import open_model_benchmark_cards.completeness as _completeness
    import open_model_benchmark_cards.portfolio_index as _portfolio_index
