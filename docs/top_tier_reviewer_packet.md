# Top-Tier Reviewer Packet: open-model-benchmark-cards
...
- Experiment or artifact index entries: **9**
- Result tables / structured outputs: **9**
- Figures: **5**
- Test files: **10**
- Scripts: **7**
- Config files: **2**
- Project-specific source modules: **9**
